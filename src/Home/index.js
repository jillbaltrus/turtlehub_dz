  ...
  return (
      <div className="row mb-3">
        ...
        <div className="col-8 mb-2">
          ...
          {currentUser &&
              <ul className="navigation-list-group rounded p-0 m-3 col-8">
                {upcomingEventsForUser.map(
                    e => <UpcomingEvent key={e._id} event={e}/>)}
              </ul>
          }
          <h2 className={"ms-2"}>All upcoming events:</h2>
          <ul className="navigation-list-group rounded p-0 m-3 mb-1 col-8">
            {nextThreeEvents.map(e => <UpcomingEvent key={e._id} event={e}/>)}
          </ul>
          <div className="text-center col-8 pt-1 mt-1">
